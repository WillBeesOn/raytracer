...
fn main() {
    ...
    let mut sphere1 = Sphere::new(
        0.25,
        Material::Phong(Phong::new(vec3![102.0, 102.0, 255.0], 0.2, 0.55, 40.0 , 0.15))
    );
    sphere1.translate(vec3![-0.7, -0.2, -2.8]);

    let mut sphere2 = Sphere::new(
        0.2,
        Material::Phong(Phong::new(vec3![76.0, 153.0, 0.0], 0.2  , 0.35, 40.0, 0.15))
    );
    sphere2.translate(vec3![0.7, 0.0, -3.0]);
    ...
    light1.set_position(vec3![0.0, 0.4, -3.5]);
